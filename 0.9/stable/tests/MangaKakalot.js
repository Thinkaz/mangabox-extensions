...
//#endregion
//#region src/MangaKakalot/pbconfig.ts
...
//#endregion
//#region src/MangaKakalot/main.ts
	const DOMAIN = "https://www.mangakakalot.gg";
	var MangaKakalotExtension = class extends Mangabox {
		constructor() {
			super({
				domain: DOMAIN,
				name: pbConfig.name,
	...
	const MangaKakalot = new MangaKakalotExtension();
