...
//#endregion
//#region src/MangaNato/pbconfig.ts
...
//#endregion
//#region src/MangaNato/main.ts
	const DOMAIN = "https://www.manganato.gg";
	var MangaNatoExtension = class extends Mangabox {
		constructor() {
			super({
				domain: DOMAIN,
				name: pbConfig.name,
	...
	const MangaNato = new MangaNatoExtension();
